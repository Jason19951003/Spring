...
insert into booking_room(room_id, user_id, checkin_date) values(101, 1, '2024-05-01');
insert into booking_room(room_id, user_id, checkin_date) values(101, 2, '2024-05-02');
insert into booking_room(room_id, user_id, checkin_date) values(202, 1, '2024-05-05');