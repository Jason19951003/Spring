...
//		ApplicationContext applicationContext = new AnnotationConfigApplicationContext(SpringJavaConfig2.class);
		Hello hello = applicationContext.getBean(Hello.class);
		System.out.println(hello.getToday());
		
		Lotto lotto1 = applicationContext.getBean(Lotto.class);
		System.out.println(lotto1.getNumbers());
		Lotto lotto2 = applicationContext.getBean(Lotto.class);
