...
public class TestBeverage {
	...
	public static void main(String[] args) {
		//ApplicationContext applicationContext = new ClassPathXmlApplicationContext("beans-config3.xml");
		ApplicationContext applicationContext = new AnnotationConfigApplicationContext(BeverageConfig.class);		
		...
		BeverageMachine machine2 = applicationContext.getBean("teaBeverageMachine", BeverageMachine.class);
